...
const ScriptController = ({previousLine, nextLine, start, stop, pause, save, review, nextContent}) => (
  <Button.Group>
    ...
    <Button labelPosition='right' icon='right chevron' content={nextContent} onClick={review}/>
  </Button.Group>
)
