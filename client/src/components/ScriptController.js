...
const ScriptController = ({previousLine, nextLine, start, stop, pause, save, review, nextContent, reviewState, recordingState}) => (
  <div className="center">
    ...
    {reviewState && <Button icon='play' content='Re-record' onClick={start}/>}
